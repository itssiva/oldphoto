...
from oldphoto.photos.models import Photo, PhotoComment, UserTag
from oldphoto.userpanel.models import CollectionPhoto,Friend
from oldphoto.utils.CommonUtils import get_base_context_map,is_superuser
